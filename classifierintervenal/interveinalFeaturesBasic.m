...
function [area_intervein, perimeter_intervein, eccentricity_intervein, major_intervein, minor_intervein, positional_feature_intervein, pigmentation_intervein] = interveinalFeaturesBasic(img, bw_label)
